...
risk2.Add(new LossEventFrequency() { Perc10 = 1, Mode = 2, Perc90 = 10, Confidence = Confidence.High });
risk2.Add(new LossMagnitude() { Perc10 = 100000, Mode = 200000, Perc90 = 1000000, Confidence = Confidence.Moderate });
